<%-- 
    Document   : login
    Created on : 18 Sep 2023, 9:12:53 AM
    Author     : User1
--%>
...
<div class="bg-img">
  <form action="LoginServlet" class="containers">
    <h2>Login</h2>
    ...
    <!--p>Don't have an account? <a href="Signup.html"><br</br>Register now</a>.</p-->
    <span class="psw2"> Don't have an account? <a href="signup.jsp">Register now</a></span>
    
  <%-- Include this code at the appropriate place in your login.jsp --%>
